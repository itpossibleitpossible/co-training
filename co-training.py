...
if __name__ == '__main__':
    ...
    base_lr = AdaBoostClassifier()
    base_lr.fit(X_labeled, y_labeled)
    y_pred = base_lr.predict(X_test)
    print(classification_report(y_test, y_pred))

    print('ExtraTreesClassifier')
    base_lr = ExtraTreesClassifier()
    base_lr.fit(X_labeled, y_labeled)
    y_pred = base_lr.predict(X_test)
    print(classification_report(y_test, y_pred))

    print('ExtraTreesClassifier-AdaBoostClassifier CoTraining')
    lg_co_clf = CoTrainingClassifier(ExtraTreesClassifier(),AdaBoostClassifier())
